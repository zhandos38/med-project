    ...
    <div class="news__item">
        <div class="row">
            <div class="col-md-4 news__img-wrapper">
                <img class="img-fluid" src="<?= $imgPath . '/web/posts/' . $model->image ?>">
            </div>
                ...
                <div class="news__content">
                    <div class="news__heading">
                        <div class="news__date">
                            <span>
                                <i class="fa fa-calendar news__date-icon"></i><?= date('d/m/Y H:i', $model->created_at) ?><br>
                            </span>
                        </div>
                        <div class="news__views">
                            <span>
                                <i class="fa fa-eye news__icon"></i><?= $model->views ? $model->views : 0 ?></span>
                        </div>
                    </div>
